...
def export_onnx(onnx_file_path):
    ...
    checkpoint_file = 'smoke_dla34_pytorch_dlaneck_gn-all_8x4_6x_kitti-mono3d_20210929_015553-d46d9bb0.pth'
    ...
    # dummy_img = torch.randn(1, 3, 384, 1280, device='cpu')
    dummy_img = torch.randn(1, 3, 480, 640, device='cpu')
    torch.onnx.export(smoke, dummy_img, onnx_file_path, opset_version=11)
    print('Saved SMOKE onnx file: {}'.format(onnx_file_path))


if __name__ == '__main__':
    export_onnx('smoke_dla34_640*480.onnx')
